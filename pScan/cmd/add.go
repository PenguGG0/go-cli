...
var addCmd = &cobra.Command{
	...
	SilenceUsage: true,                  // Don't show usage when an error occurs to avoid infomation overload for user
	Args:         cobra.MinimumNArgs(1), // Validate the arguments provided to command
